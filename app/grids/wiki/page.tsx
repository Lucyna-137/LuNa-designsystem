...
export default function GridWikiPage() {
  return (
    <div className="bg-grey-900 min-h-screen">
      ...
      >
        <div className="relative size-full">
          {/* Scroll Navigation */}
          <ScrollNavigation currentPage="grids-wiki" />
              ...
              >
                <div className="relative shrink-0 text-[0px] w-full">
                  <p className="leading-[1.4] text-text-large">
                    <span>Core /</span>
                    <span className="font-host-grotesk not-italic text-grey-300">{` Grids & Spacing / Wiki `}</span>
                  </p>
                </div>
