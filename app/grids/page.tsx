    ...
    <div className="bg-grey-900 min-h-screen">
      ...
      >
        <div className="relative size-full">
          {/* Scroll Navigation */}
          <ScrollNavigation currentPage="grids" />
          ...
          <div className="fixed-padding-container relative size-full">
              ...
              >
                <div className="relative shrink-0 text-[0px] w-full">
                  <p className="leading-[1.4] text-text-large">
                    <span>Core /</span>
                    <span className="font-host-grotesk not-italic text-grey-300">{` Grids & Spacing / Grid System`}</span>
                  </p>
                </div>
              ...
              >
                ...
                >
                  ...
                  <div className="relative shrink-0 text-grey-300 text-[18px] w-full max-w-[700px]">
                    <p className="block leading-[1.4]">
                      This brand system uses a fluid grid system - meaning it is not fixed on a pixel value and will adapt to the size of the screen that you're designing for.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="font-ibm-plex-sans-jp relative shrink-0 text-grey-300 text-[18px] w-full max-w-[700px]">
                    <p className="block leading-[1.4]">
                      このブランドシステムでは流動的なグリッドシステムを採用しており、特定のピクセル値に固定されず、デザイン対象の画面サイズに応じて柔軟に調整されます。
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* 8 Column Grid Section */}
            <div
              className="box-border content-stretch flex flex-col gap-20 items-start justify-start px-0 pt-[80px] pb-[100px] relative shrink-0 content-responsive"
              data-name="8 Column Grid"
            >
              <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-0 relative shrink-0">
                <div className="font-host-grotesk font-normal relative shrink-0 text-grey-50 text-[32px] tracking-[-0.64px]">
                  <p className="adjustLetterSpacing block leading-[1.3]">
                    8 Column Grid
                  </p>
                </div>
            ...
            {/* 6 Column Grid Section */}
            <div
              className="box-border content-stretch flex flex-col gap-20 items-start justify-start px-0 pt-[80px] pb-[100px] relative shrink-0 content-responsive"
              data-name="6 Column Grid"
            >
              <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-0 relative shrink-0">
                <div className="font-host-grotesk font-normal relative shrink-0 text-grey-50 text-[32px] tracking-[-0.64px]">
                  <p className="adjustLetterSpacing block leading-[1.3]">
