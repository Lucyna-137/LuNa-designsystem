  ...
  return (
    <div className="bg-grey-900 min-h-screen">
      <div
        ...
        data-name="Color Documentation"
      >
        <div className="relative size-full">
          {/* Scroll Navigation */}
          <ScrollNavigation currentPage="color-documentation" />
          ...
          <div className="fixed-padding-container relative size-full">
              ...
              >
                <div className="relative shrink-0 text-[0px] w-full">
                  <p className="leading-[1.4] text-text-large">
                    <span>Core /</span>
                    <span className="font-host-grotesk not-italic text-grey-300">{` Color / Documentation `}</span>
                  </p>
                </div>
            ...
            <div
              ...
              data-name="Accessing The Colors"
            >
              <div
                ...
                >
                  ...
                  <div className="relative shrink-0 text-grey-300 text-[18px] w-full">
                    <p className="block leading-[1.4]">
                      All colors are saved as Styles in Figma and can be access from the menu on the right hand side.
                    </p>
                  </div>
                </div>
                <div
                  ...
                  data-name="Description"
                >
                  <div className="font-ibm-plex-sans-jp relative shrunk-0 text-grey-50 text-heading-small tracking-[-0.48px] w-full">
                  ...
                  <div className="font-ibm-plex-sans-jp relative shrink-0 text-grey-300 text-[18px] w-full">
                    <p className="block leading-[1.4]">
                      すべてのカラーはFigmaの「スタイル」として保存されており、右側のメニューから簡単にアクセスできます。
                    </p>
                  </div>
                </div>
              </div>
              <div
                className="box-border content-stretch flex flex-col items-start justify-start p-0 relative shrink-0 w-full h-auto"
                data-name="Image"
              >
                <img
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="font-ibm-plex-sans-jp relative shrink-0 text-grey-300 text-[18px] w-full">
                    <p className="block leading-[1.4]">
                      Figmaで要素を選択したら、右側のカラーパネルをクリックし、選択した要素に適したカラーを選んで適用してください。
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Updating The Colors Section */}
            <div
              className="box-border content-stretch flex flex-col gap-20 items-start justify-start px-0 py-[100px] relative shrink-0 content-responsive"
              data-name="Updating The Colors"
            >
              <div
                className="box-border content-stretch flex flex-col lg:flex-row gap-12 lg:gap-24 items-start justify-start p-0 relative shrink-0"
                data-name="Description"
              >
                ...
                >
                  ...
                  <div className="relative shrink-0 text-grey-300 text-[18px] w-full">
                    <p className="block leading-[1.4]">
                      If you would like to modify and update the palette, you can edit local styles from the right sidebar and from the style picker. Hover over the style, then click the style adjust icon when it appears.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="font-ibm-plex-sans-jp relative shrink-0 text-grey-300 text-[18px] w-full">
                    <p className="block leading-[1.4]">
                      パレットを変更・更新したい場合は、右側のサイドバーやスタイルピッカーからローカルスタイルを編集できます。スタイルの上にカーソルを合わせると編集アイコンが表示されるので、それをクリックして調整してください。
                    </p>
                  </div>
                </div>
              </div>
